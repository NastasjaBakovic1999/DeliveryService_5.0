...
namespace DeliveryServiceApp.Services.Implementation
{
    public class ServiceShipment : IServiceShipment
    {
		...
		private bool IsValid(Shipment shipment)
		{
			...
			if (string.IsNullOrEmpty(shipment.ShipmentCode) || string.IsNullOrEmpty(shipment.ShipmentContent) || string.IsNullOrEmpty(shipment.Sending.Street) ||
				string.IsNullOrEmpty(shipment.Sending.City) || string.IsNullOrEmpty(shipment.Sending.PostalCode) || string.IsNullOrEmpty(shipment.Receiving.Street) ||
				string.IsNullOrEmpty(shipment.Receiving.City) || string.IsNullOrEmpty(shipment.Receiving.PostalCode) || string.IsNullOrEmpty(shipment.ContactPersonName) ||
